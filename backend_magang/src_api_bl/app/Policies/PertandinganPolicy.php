...
class PertandinganPolicy
{
    ...
    {
        return $user->can('view_any_pertandingan');
    }
    ...
    {
        return $user->can('view_pertandingan');
    }
    ...
    {
        return $user->can('create_pertandingan');
    }
    ...
    {
        return $user->can('update_pertandingan');
    }
    ...
    {
        return $user->can('delete_pertandingan');
    }
    ...
    {
        return $user->can('delete_any_pertandingan');
    }
     ...
     */
    public function replicate(User $user, Pertandingan $pertandingan): bool
    {
