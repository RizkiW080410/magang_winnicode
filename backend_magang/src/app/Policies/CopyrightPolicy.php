...
class CopyrightPolicy
{
    ...
    {
        return $user->can('view_any_copyright');
    }
    ...
    {
        return $user->can('view_copyright');
    }
    ...
    {
        return $user->can('create_copyright');
    }
    ...
    {
        return $user->can('update_copyright');
    }
    ...
    {
        return $user->can('delete_copyright');
    }
    ...
    {
        return $user->can('delete_any_copyright');
    }
     ...
     */
    public function replicate(User $user, Copyright $copyright): bool
    {
