...
class PanganPolicy
{
    ...
    {
        return $user->can('view_any_pangan');
    }
    ...
    {
        return $user->can('delete_any_pangan');
    }
     ...
     */
    public function replicate(User $user, Pangan $pangan): bool
    {
